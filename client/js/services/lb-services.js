      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Tracks/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Vehicle.tracks.findById() instead.
            "::findById::Vehicle::tracks": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Vehicles/:id/tracks/:fk",
              method: "GET",
            },

            // INTERNAL. Use Vehicle.tracks.destroyById() instead.
            "::destroyById::Vehicle::tracks": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Vehicles/:id/tracks/:fk",
            ...
            // INTERNAL. Use Vehicle.tracks.updateById() instead.
            "::updateById::Vehicle::tracks": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Vehicles/:id/tracks/:fk",
            ...
            // INTERNAL. Use Vehicle.tracks() instead.
            "::get::Vehicle::tracks": {
              isArray: true,
              url: urlBase + "/Vehicles/:id/tracks",
              method: "GET",
            },

            // INTERNAL. Use Vehicle.tracks.create() instead.
            "::create::Vehicle::tracks": {
              url: urlBase + "/Vehicles/:id/tracks",
              method: "POST",
            },

            // INTERNAL. Use Vehicle.tracks.createMany() instead.
            "::createMany::Vehicle::tracks": {
              isArray: true,
              url: urlBase + "/Vehicles/:id/tracks",
              method: "POST",
            },

            // INTERNAL. Use Vehicle.tracks.destroyAll() instead.
            "::delete::Vehicle::tracks": {
              url: urlBase + "/Vehicles/:id/tracks",
              method: "DELETE",
            },

            // INTERNAL. Use Vehicle.tracks.count() instead.
            "::count::Vehicle::tracks": {
              url: urlBase + "/Vehicles/:id/tracks/count",
              method: "GET",
            },
          }
        );
            ...
            /**
             * @ngdoc method
             * @name lbServices.Track#patchOrCreate
             * @methodOf lbServices.Track
             *
             * @description
             *
        ...
        R["removeById"] = R["deleteById"];
            ...
            /**
             * @ngdoc method
             * @name lbServices.Track#prototype$patchAttributes
             * @methodOf lbServices.Track
             *
             * @description
             *
 ...
 */
  module.factory(
      ...
      function(Resource, LoopBackAuth, $injector) {
        ...
        urlBase + "/Vehicles/:id",
          { 'id': '@id' },
          {
            ...
            // INTERNAL. Use Vehicle.tracks.destroyById() instead.
            "prototype$__destroyById__tracks": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Vehicles/:id/tracks/:fk",
            ...
            // INTERNAL. Use Vehicle.tracks.updateById() instead.
            "prototype$__updateById__tracks": {
              params: {
                'fk': '@fk',
              },
              url: urlBase + "/Vehicles/:id/tracks/:fk",
    ...
    /**
     * @ngdoc object
     * @name lbServices.Vehicle.tracks
     * @header lbServices.Vehicle.tracks
     * @object
     * @description
     *
     * The object `Vehicle.tracks` groups methods
     * manipulating `Track` instances related to `Vehicle`.
     *
     * Call {@link lbServices.Vehicle#tracks Vehicle.tracks()}
     ...
     */
        ...
        R.tracks = function() {
          ...
          var action = TargetResource["::get::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#count
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
             * Counts tracks of Vehicle.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
        ...
        R.tracks.count = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::count::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#create
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
        ...
        R.tracks.create = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::create::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#createMany
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
        ...
        R.tracks.createMany = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::createMany::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#destroyAll
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
             * Deletes all tracks of this model.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             */
        R.tracks.destroyAll = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::delete::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#destroyById
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
             * Delete a related item by id for tracks.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             *
             *  - `fk` – `{*}` - Foreign key for tracks
             *
             * @param {function(Object,Object)=} successCb
             *   Success callback with two arguments: `value`, `responseHeaders`.
             *
             ...
             * This method returns no data.
             */
        R.tracks.destroyById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::destroyById::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#findById
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
             * Find a related item by id for tracks.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.tracks.findById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::findById::Vehicle::tracks"];
          return action.apply(R, arguments);
        };

            /**
             * @ngdoc method
             * @name lbServices.Vehicle.tracks#updateById
             * @methodOf lbServices.Vehicle.tracks
             *
             * @description
             *
             * Update a related item by id for tracks.
             *
             * @param {Object=} parameters Request parameters.
             *
             *  - `id` – `{*}` - PersistedModel id
             ...
             * </em>
             */
        R.tracks.updateById = function() {
          var TargetResource = $injector.get("Track");
          var action = TargetResource["::updateById::Vehicle::tracks"];
          return action.apply(R, arguments);
        };
